...
食间是家庭饮食决策平台。第一版目标不是完整商业平台，而是帮家里先解决“今晚吃什么”，再顺手把菜单、买菜清单和家中库存安排明白。
...
2. 食间 V3 信息架构：品牌文案、今晚吃什么首页、移动端 4 tab。
...
- 食间移动端上线已经进入验收阶段，线上地址为 `https://hlj1029.github.io/family-menu/`。
