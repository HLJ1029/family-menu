...
- 最新小程序上传：`1.1.66`，描述 `适配新版五入口与家庭协作`，AppID `wx4040b89f3b363416`。
...
- 不要在真机验收期间无记录覆盖 `1.1.66`；发现 P0/P1 时先登记、修复、复测，再上传新的 1.1.x 候选。
...
```text
/Users/honglijie/.humi-release-evidence/miniprogram-upload-1.1.66
```
...
- 微信开发者工具 CLI 已完成 `1.1.66` 上传，但本机 CLI 没有提交审核/发布命令。
