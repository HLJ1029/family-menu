...
- 本地待封包版本：`1.1.77`
- 本地版本描述：`Humi 原生家庭协作与分享闭环候选`
- 当前已上传体验版：`1.1.75@fbb4938`
- AppID：`wx4040b89f3b363416`
- H5：`https://www.humi-home.com/`
- API：`https://api.humi-home.com`
- 当前状态：N5a H5/API 已部署；`1.1.75@fbb4938` 已按 N5b-1.1.75 上传为体验版。`1.1.76` 的本地视觉封包已被后续家庭协作与历史分享落地修复取代；当前待封包候选为 `1.1.77`。真实上传仍需新的动作级授权；提审、发布、开关和白名单均未执行。
