...
- 当前体验版：`1.1.78@7606aad`
- 当前版本描述：`Humi 原生主动登录与家庭协作闭环候选`
- 当前已上传体验版：`1.1.78@7606aad`
- AppID：`wx4040b89f3b363416`
- H5：`https://www.humi-home.com/`
- API：`https://api.humi-home.com`
- 当前状态：N5a API 与 PR #39 H5 热修复已部署；`1.1.78@7606aad` 已按 N5b-1.1.78 上传为体验版。`1.1.75` 的空会话只作历史，`1.1.76` 与 `1.1.77` 的本地封包已被主动登录修复取代；提审、发布、开关和白名单均未执行。
