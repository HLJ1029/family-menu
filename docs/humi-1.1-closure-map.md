...
| 候选交付到远端并合入发布基线 | 10 | 10 | PR #3 至 #7 已合并，当前 `origin/main` 为 `470250d` |
| 部署 H5/API、上传新小程序候选并完成候选 P0 | 15 | 15 | H5 Pages run `29337705997` 成功；API 已部署并重启；小程序 `1.1.61` 已上传；线上迁移、产品与协作 smoke 零错误。真实微信验收进入下一阶段 |
...
- H5 部署：`main` 合并提交 `470250d` 已由 GitHub Pages run `29337705997` 成功部署。
