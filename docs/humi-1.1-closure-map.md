...
- 提审前 P0/P1：本轮产品功能整改已通过自动化；`docs/humi-1.1-pre-review-hardening.md` 仍保留“家庭订阅结算范围”和两张微信原生分享截图开放项。
...
- 分享卡片：三张 H5 landing 与 `grocery-card.png` 已通过；历史 `crave-card.png`、`invite-card.png` 被新 OCR 语义门禁判定无效，待在当前分支重新截取。
