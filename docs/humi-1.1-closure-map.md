...
| 候选交付到远端并合入发布基线 | 10 | 10 | PR #3 至 #11 已合并，当前 `origin/main` 为 `de0b4d8` |
| 部署 H5/API 并上传新小程序候选 | 10 | 10 | H5 Pages run `29340371940` 成功；API 已部署并重启；小程序 `1.1.63` 已上传；线上迁移、产品与协作 smoke 零错误 |
...
- H5 部署：`main` 合并提交 `de0b4d8` 已由 GitHub Pages run `29340371940` 成功部署。
