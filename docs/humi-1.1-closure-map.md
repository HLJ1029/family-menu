...
Humi 1.1 已形成可供真机验收的生产候选：核心家庭菜单与协作改动已合入 `main`，H5/API 已部署，小程序 `1.1.60` 已上传，线上产品与游客协作 smoke 均为零页面错误。微信审核和正式发布尚未触发；下一步只验证真实微信中的打开、分享和家庭协作，不再扩大 1.1 功能范围。
...
| 部署 H5/API、上传新小程序候选并完成候选 P0 | 15 | 15 | H5 Pages run `29334784527` 成功；API 已部署并重启；小程序 `1.1.60` 已上传；线上产品与协作 smoke 零错误。真实微信验收进入下一阶段 |
...
- 小程序上传：`1.1.60` / `核心菜单与家庭协作验收版` / AppID `wx4040b89f3b363416` / package `20.1 KB`。
...
先完成产品功能，再谈审核。
先用微信开发者工具或体验版打开 `1.1.60`，完成 1.1 核心菜单与协作真机验收。
