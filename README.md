...
Humi 致力于将产品从”家庭饮食管理工具”升级为”家庭饮食决策平台”：用户打开后，首先解决”今天吃什么”的核心问题，并能继续安排早餐、午餐、晚餐，进而顺畅地规划本周饮食、采购清单和家中库存管理。

## 已实现功能

- 首页围绕”今天吃什么？”组织，提供清晰的晚餐决策入口，并展示今日三餐状态。
- 聚合今日推荐、三餐计划、一周计划、食材清单和家中库存。
