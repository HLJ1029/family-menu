  ...
  onShareAppMessage() {
    ...
    if (shareMealTask?.token) {
      return {
        ...
        path: `/pages/boot/index?mealTask=${encodeURIComponent(shareMealTask.token)}&shareSource=meal_task`
      };
    }
    ...
    if (shareWish?.token) {
      return {
        ...
        path: `/pages/boot/index?wishShare=${encodeURIComponent(shareWish.token)}`
      };
    }
    ...
    if (shareMenu?.token) {
      return {
        ...
        path: `/pages/boot/index?menuShare=${encodeURIComponent(shareMenu.token)}`
      };
    }
    ...
    if (shareGrocery?.token) {
      ...
      return {
        ...
        path: `/pages/boot/index?groceryShare=${encodeURIComponent(shareGrocery.token)}`
      };
    }
    ...
    if (shareInvite?.token) {
      return {
        ...
        path: `/pages/boot/index?invite=${encodeURIComponent(shareInvite.token)}`
      };
    }
    ...
    if (shareCrave?.token) {
      return {
        ...
        path: `/pages/boot/index?crave=${encodeURIComponent(shareCrave.token)}`
      };
    }
    return {
