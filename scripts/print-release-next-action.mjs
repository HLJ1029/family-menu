...
if (openHardeningItems.length) {
  ...
  if (shareEvidence?.missingFiles?.length) {
    ...
    lines.push("4. 如缺 landing 图，先运行 npm run release:wechat:share:landings 自动补齐；如缺 card 图，可运行 npm run release:wechat:share:cards:capture 辅助保存，或用 npm run release:wechat:share:cards:import 导入已有截图。");
