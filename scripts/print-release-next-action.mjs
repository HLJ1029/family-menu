...
function getNextEvidenceStage(missing, submitEvidence) {
  if (missing.includes("## 4. 微信公众平台提交审核证据")) {
    ...
    return {
      ...
      actions: [
        ...
        "运行 npm run release:wechat:check 只做只读预检，确认版本 1.1.63、域名、隐私保护指引、审核备注和证据目录仍可用。",
  ...
  if (missing.includes("## 6. 审核通过后发布证据")) {
    return {
      ...
      actions: [
        "如果审核结果是通过，进入微信公众平台版本管理，找到 1.1.63 并点击发布。",
