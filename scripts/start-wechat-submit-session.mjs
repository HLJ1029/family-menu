...
const sessionDir = join(baseDir, `wechat-submit-1.1.56-${stamp}`);
...
- [ ] 版本管理中能看到上传版本 1.1.56，描述为“分享卡片转发兜底”
