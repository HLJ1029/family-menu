...
const sessionDir = join(baseDir, `wechat-submit-1.1.54-${stamp}`);
...
- [ ] 版本管理中能看到上传版本 1.1.54，描述为“征集加入状态同步”
