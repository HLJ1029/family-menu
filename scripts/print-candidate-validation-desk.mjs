...
lines.push("8. 收到单个反馈后先运行 `release:candidate:record:draft -- --user U00X --date YYYY-MM-DD --entry \"入口任务\"` 生成私有回填草稿，再用 `release:candidate:record` 或 `candidate-feedback-import.csv` 回填匿名结果。");
...
lines.push(`- npm run release:candidate:record:draft -- --user U001 --date ${today} --entry "问问大家小程序卡片"`);
