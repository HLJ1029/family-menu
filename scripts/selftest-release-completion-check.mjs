...
const tempDir = await mkdtemp(join(tmpdir(), "humi-release-complete-"));
...
async function fillCompleteEvidence(evidencePath) {
  const env = { HUMI_EVIDENCE_LOG_PATH: evidencePath };
