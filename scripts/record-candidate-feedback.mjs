...
function buildRecordFromInput(input) {
  ...
  return {
    ...
    recommendationScore: normalizeScore(field(input, "recommendation", "推荐评分"), "recommendation", { allowSkipped: true }),
    groceryScore: normalizeScore(field(input, "groceryScore", "grocery-score", "清单评分"), "grocery-score", { allowSkipped: true }),
