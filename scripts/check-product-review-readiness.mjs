...
const REQUIRED_CHECKS = [
  ...
  },
  {
    ...
    required: ["data-testid=\"family-living-room\"", "正在一起做", "家庭偏好", "activeCollaborations.slice(0, 3)", "current-family-role", "current-family-member-avatars", "current-family-member-count", "family-preference-action"],
    forbidden: ["CloudSyncPanel", "营养目标", "验证数据"],
    evidence: "scripts/smoke-product-entrypoints.mjs",
    evidenceRequired: ["family-living-room-has-four-focused-sections", "family-living-room-removes-cloud-ai-nutrition-and-export-clutter", "signed-in-no-household-does-not-fabricate-family", "family-living-room-shows-current-role", "family-living-room-shows-member-avatars-and-count", "family-preference-opens-household-settings"],
  },
  {
