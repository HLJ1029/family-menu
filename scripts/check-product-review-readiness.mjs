...
const REQUIRED_CHECKS = [
  ...
  },
  {
    ...
    path: "src/components/UserCenter.jsx",
    required: ["household-switcher", "当前家庭空间", "切换家庭", "onSwitch"],
    evidence: "scripts/smoke-product-entrypoints.mjs",
  ...
  },
  {
    ...
    evidenceRequired: ["不用登录，不用想菜名，点一个感觉就行", "不用登录。先认领", "一家人的饭放在一起", "wish-posted-without-login", "auth/wechat/login"],
  },
  {
  ...
  },
  {
    ...
    path: "src/components/Library.jsx",
    required: ["canManageHousehold", "加入想吃池子", "draggable={canManageHousehold}"],
    evidence: "scripts/smoke-product-entrypoints.mjs",
  ...
  },
  {
    ...
    evidence: "scripts/smoke-product-entrypoints.mjs",
    evidenceRequired: ["www.humi-home.com", "full-library-title", "full-library-card-count", "user-center-crave-sheet", "breakfast-does-not-default-to-seaweed-soup", "lunch-home-saves-user-picked-dish", "lunch-does-not-default-to-seaweed-soup", "grocery-share-opens-native-share-page", "crave-share-opens-native-share-page"],
  },
  {
