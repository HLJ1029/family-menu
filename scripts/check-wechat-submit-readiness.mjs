...
const packet = {
  ...
  requiredPlatformChecks: [
    "Version 1.1.64 is visible in WeChat Mini Program version management.",
  ...
  nextActions: submitReady
    ? [
      ...
      "After confirmation, open WeChat public platform and prepare version 1.1.64 for review.",
