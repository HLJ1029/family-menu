...
const report = {
  ...
  release: {
    ...
    miniProgramUploadedVersion: release.miniProgramUploadedVersion ?? release.miniProgramRecordedUploadVersion ?? "unknown",
    miniProgramUploadVerified: Boolean(release.currentCandidateUploaded),
    miniProgramUploadRecorded: Boolean(release.currentCandidateUploadRecorded),
